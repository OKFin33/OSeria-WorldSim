...
export type LandingNameMode = "custom" | "generated";
export type ScopeName = "unset" | "micro" | "meso" | "macro";
export type ScopeAnchor = "self" | "relationship" | "group" | "system";
export type ScopeReason = "user_explicit" | "inferred" | "fallback";
...
export interface ScopeState {
  primary_scope: ScopeName;
  primary_anchor: ScopeAnchor;
  scope_locked: boolean;
  reason: ScopeReason;
  unresolved_foundations: string[];
}
...
export interface LandingPayload {
  user_gender: "男" | "女" | "其他";
  avatar_gender: "男" | "女" | "其他" | "世界提供";
  name_mode: LandingNameMode;
  custom_name?: string;
}
