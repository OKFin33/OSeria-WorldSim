...
const API_BASE_URL = import.meta.env.VITE_API_BASE_URL ?? `${window.location.origin}/architect-api`;
const RUNTIME_API_BASE_URL =
  import.meta.env.VITE_RUNTIME_API_BASE_URL ?? `${window.location.origin}/runtime-api`;
