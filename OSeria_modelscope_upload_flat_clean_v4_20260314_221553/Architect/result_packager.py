...
from .domain import CompileOutput, ProtagonistIdentity
    ...
    def build_blueprint(
        ...
        *,
        ...
        return BlueprintModel(
            ...
            protagonist_name=protagonist_identity.protagonist_name.strip(),
            protagonist_gender=protagonist_identity.protagonist_gender.strip() or "unknown",
            protagonist_identity_brief=protagonist_identity.protagonist_identity_brief.strip(),
